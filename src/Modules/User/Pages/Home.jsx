      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
        <div className="Home">
          ...
          <div className="about-us">
            <h2>About Us</h2>
            <p>We are passionate about food and fashion, delivering the best experiences for our customers. Join us and explore a wide variety of choices, from delicious meals to fashionable trends.</p>
          </div>

          {/* Contact Us Section */}
          <div className="contact-us">
            <h2>Contact Us</h2>
            <p>If you have any questions or inquiries, feel free to reach us at:</p>
